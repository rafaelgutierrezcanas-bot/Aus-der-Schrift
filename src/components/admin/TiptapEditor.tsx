    ...
    <div className={wrapperClass}>
      ...
      {selectionBubble && (
        <button
          ...
          className="fixed z-50 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-stone-800 text-white text-xs font-medium shadow-lg hover:bg-stone-900 transition-colors"
          style={{ top: selectionBubble.top, left: selectionBubble.left, fontFamily: "var(--font-sans)" }}
        >
          Ersetzen
        </button>
      )}
